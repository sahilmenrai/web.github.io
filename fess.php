...
<div class="container">
 ...
 <div class="col-sm-5">
  ...
  <div class="row">
  	<div class="col-sm-12">
  	<p style="margin-top: 131px;font-family: 'Vollkorn SC', serif;font-size: 33px; text-align: center">Fees Payment & Policy</p>
  ...
  <div class="container-fluid" style="margin-top: 51px; margin-bottom: 51px;">
			<div class="row">
			<div class="col-sm-6">
			<p style="font-family: 'Vollkorn SC', serif;font-size: 25px; text-align: center">Fees </p>
				<p>Our consultations are organised by appointment only. Once you make an appointment with us, one of our Lawyers who are also Registered Migration Agents will evaluate your status and advise you on your options.</p>
				<p>We charge a fee of A$ 440 for our initial consultancy. We charge a special rate of $ 220 to on-shore students.   During the first appointment, we will quote you a fixed lump sum fee for you specific matter or quote you an hourly rate. Our hourly rate is $ 330.00 per hour. If we agree to a lump sum fee for a particular matter, our costs are capped to that amount.</p>
				<p>We give you a cost agreement and disclosure statement in keeping with the Legal Profession Act 2004 . This document explains in detail the costs that you will incur and any extra fees that you may be likely to incur. It is our policy to deposit your money in to our Statutory Trust Account if payment is made before the work is commenced. This account is subject to audit by the Regulatory Body.</p>
				
			</div>
				<div class="col-sm-6">
					<p style="font-family: 'Vollkorn SC', serif;font-size: 25px; text-align: center">Our Refund Policy </p>
				<p>Applications will only be lodged if they satisfy the legislative criteria. Applications will be based on the information and documents given to us by our clients. Clients must give us correct information and genuine documents. We cannot be held responsible if for any reason an application is refused for reasons based on incorrect information or a bogus document provided with an application for a visa.</p>
				<p>We do not guarantee the successful outcome of any legal work undertaken. We charge you for work completed and are not responsible for an adverse decision beyond our control which may include negligent conduct of public officers, incorrect decision made by a delegate or incorrect or incomplete instruction, or unanticipated changes in legislation.</p>
				<p>As legal practitioners we are required to hold Professional Indemnity insurance against professional negligence. For more information please refer to our disclosure statement.</p>
