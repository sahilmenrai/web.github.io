...
<link href="css/f.css" rel="stylesheet" type="text/css" media="all"/>
...
<div class="container-fluid" id="contact" data-parallax="scroll" data-image-src="images/b.png" style="margin-top: 99px;">
		<section class="agileits-contactus">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						
							<h3 class="w3l-title" style="font-family: 'Vollkorn SC', serif; color: #FFFFFF;">Get in touch</h3>
						...
						<div class="col-sm-8 w3layouts-agileits">
							<form action="#" method="post" class="my-form">
								<div class="form-group">
									<input type="text" class="form-control animated bounceInUp delay-9s"  name="name" id="name" placeholder="Name" required="required">
								</div>
								<div class="form-group">
									<input type="text" class="form-control animated bounceInUp slow"  name="conatct" id="" placeholder="Contact Number" required="required">
								</div>
								<div class="form-group">
									<input type="email" class="form-control  animated bounceInUp"  name="email" id="email" placeholder="Email" required="required">
								</div>
								<div class="form-group">
									<textarea class="form-control  animated bounceInUp"  name="msg" id="message" rows="7" cols="25" style="resize:none;" required="required" placeholder="Enquiry"></textarea>
								</div>

								<button type="submit" name="submit" class="btn btn-default btn-block  animated bounceInUp" data-wow-duration="3.0s">SEND MESSAGE</button>
							</form>
						</div>

						<div class="col-sm-4 w3layouts-agileits">
							<div class="w3layouts-address animated bounceInRight">
								<h4 style="color: #FBFBFB;"><strong>Address</strong></h4>

								<address style="color: #FBFBFB;">
						  <strong class="bold"></strong><br>
						  Australia:<br>
						  Unit 12, 1 Bromham Place Richmond Vic 3121.<br>
						  T: 0394281198  M: 0412356786<br>
						  USA:<br> 
						 2722 Forino Lane, No. 2, San Jose CS 95111 USA. <br>
						 T: 408 335 7802 M: 310 343 0930<br>
								...
								<address style="color: #FBFBFB;">
						  <strong class="bold" style="color: #FBFBFB;">Skype</strong><br>
						  <a class="mail" style="text-decoration: none; color: #FCFCFC;" href="">dagama.pereirausa</a>
						</address>
							
								<address>
						  <strong class="bold" style="color: #FBFBFB;">We're on social networks</strong><br>
							<div>
		...
		<div class="box">
			<div class="row" style="margin-top: 20px; margin-bottom: 20px;">
				<div class="col-sm-12">
					...
					<h2 class="intro-text text-center" style="font-family: 'Vollkorn SC', serif; ">Location</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="container-fluid">
		<div class="box">
			<div class="row">
				<div class="col-sm-12" style="margin: 0;padding: 0; margin-bottom: 31px;">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3152.0121735636026!2d144.99656101506199!3d-37.8131838417827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642fa33a25ae7%3A0x96c3704115557721!2s12%2F1+Bromham+Pl%2C+Richmond+VIC+3121!5e0!3m2!1sen!2sau!4v1564800351095!5m2!1sen!2sau" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
				</div>
			</div>
