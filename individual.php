...
<div class="container">
 ...
 <div class="col-sm-5">
  ...
  <div class="section" data-parallax="scroll" style="background-image: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6))" data-image-src="images/bus.jpg"  >
<div class="container" style="margin-top: 131px;">
	<div class="services animated fadeInDown">
	<h1></h>
		<h6 style="margin-top: 45px; font-size: 33px;font-family: 'Vollkorn SC', serif;">Individual Visa</h6>
		<p >If you are looking to live and work in Australia we can assist you.</p>
			<p >Engaging our services at the start of the application process will save you time and money.</p>
	</div>
	<div class="row">
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Skilled Migration (Points Tested) [189, 190]</h5>
			
		</div>
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Short term visa 3– 6 months [400]</h5>
			
		</div>
		<div class="col-sm-4 text-center h animated slideInRight">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Employer Sponsored – Temporary (up to 2 years)  [482] </h5>
			
		</div></div>
		<div class="row">
		<div class="col-sm-4 text-center h animated slideInRight">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Employer Sponsored – Temporary (up to 4 years) [482] – Transits to Permanent [186]</h5>
		...
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Employer Sponsored – Permanent Residence  [186] </h5>
			
		</div>
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Skilled Regional visa  [491, 494]  (Provisional) </h5>
	...
	<div class="row">
		<div class="col-sm-4 text-center h animated slideInRight">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">	Permanent Skilled Regional visa pathway [191]</h5>
		...
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">DAMA – Designated Area Migration Agreement </h5>
			
		</div>
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Partner Visas (Spouse & De facto) [820/801, 309/100] </h5>
	...
	<div class="row">
		<div class="col-sm-4 text-center h animated slideInRight">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">	Student Visa  [500]</h5>
		...
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">	Global Talent Tech Start-up Visa (new) [482] </h5>
			
		</div>
		<div class="col-sm-4 text-center h animated slideInLeft">
			<div class="icon"><i class="fa fa-plane"></i></div>
			<h5 style="color: white;">Entrepreneur Visa South Australia  [408] </h5>
